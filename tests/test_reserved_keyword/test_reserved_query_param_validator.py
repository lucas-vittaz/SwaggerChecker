...
from src.validators.projet.reserved_keywords.reserved_query_param_validator import ReservedQueryParamValidator
...
def test_validate_reserved_query_parameters_passant(swagger_dict_passant, swagger_text, reserved_query_parameters):
    validator = ReservedQueryParamValidator(swagger_dict_passant, swagger_text, reserved_query_parameters)
...
def test_validate_reserved_query_parameters_non_passant(swagger_dict_non_passant, swagger_text, reserved_query_parameters):
    validator = ReservedQueryParamValidator(swagger_dict_non_passant, swagger_text, reserved_query_parameters)
    errors = validator.validate_reserved_query_parameters()
