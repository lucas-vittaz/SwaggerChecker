...
from src.validators.projet.reserved_keywords.reserved_header_validator import ReservedHeaderValidator
...
def test_validate_reserved_headers_passant(swagger_dict_passant, swagger_text, reserved_headers):
    validator = ReservedHeaderValidator(swagger_dict_passant, swagger_text, reserved_headers)
...
def test_validate_reserved_headers_non_passant(swagger_dict_non_passant, swagger_text, reserved_headers):
    validator = ReservedHeaderValidator(swagger_dict_non_passant, swagger_text, reserved_headers)
    errors = validator.validate_reserved_headers()
